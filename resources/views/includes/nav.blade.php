        ...
        <div class="header">
                <div class="container mt-3">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="#"><img src="photos/socialicon/youtube.png" alt="youtube" style="height: 23px;"></a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="#"><img src="photos/socialicon/twitter.png" alt="twitter" style="height: 23px;"></a>
                        </li>
                    </ul>
                </div>
        </div>
		...
		<div class="navsection">
				<nav class="navbar navbar-expand-lg">
					<div class="container-fluid ">
						...
						<img src="photos/socialicon/jobseeker.png" alt="img" width="50px">Job Portal BD</a>
						 ...
						 <div class="collapse navbar-collapse" id="navbarScroll">
							 ...
							 <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
								...
								<li class="nav-item">
								<a class="nav-link" href="/jobdetails">Job Details</a>
								</li>
